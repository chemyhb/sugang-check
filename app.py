...
matrix_data = {
    ...
    "과학": {
        ...
        "3-2": [("3-2-G", "과학의 역사와 문화", "융합"), ("3-2-G", "기후변화와 환경생태", "융합")]
    },
    "기술·가정/정보/\n제2외국어/한문": {
    ...
    "예술 / 체육": {
        ...
        "3-2": [("3-2-G", "운동과 건강", "진로"), ("3-2-G", "음악 감상과 비평", "진로")]
    },
    "교양": {
        "2-1": [],
        "2-2": [],
        "3-1": [("3-1-F", "인간과 철학", "진로"), ("3-1-F", "보건", "진로")],
        "3-2": [("3-2-H", "생태와 환경", "일반"), ("3-2-H", "인간과 심리", "진로"), ("3-2-H", "교육의 이해", "진로"), ("3-2-H", "인간과 경제활동", "융합"), ("3-2-H", "논리와 사고", "진로"), ("3-2-H", "생애 설계와 자립*", "융합")]
    }
}
